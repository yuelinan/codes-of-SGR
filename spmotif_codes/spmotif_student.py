...
from utils import init_weights, get_args, eval_spmotif,train_student
...
def main(args):
    ...
    datadir = './data/'
    bias = args.teacher_model.split('/')[-1].split('_')[0][7:]
    ...
    model = eval(args.model_name)(args, gnn_type = args.gnn, num_tasks = 3, num_layer = args.num_layer,
