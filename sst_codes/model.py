...
class GraphSST2Net(torch.nn.Module):
    ...
    def __init__(self, num_tasks, num_layer = 5, emb_dim = 300, gnn_type = 'gin', drop_ratio = 0.5, gamma = 0.4, use_linear_predictor=False):
        ...
        self.node_enoder = nn.Linear(768,self.emb_dim)
...
class Graph_Student_MSE(torch.nn.Module):
    ...
    def __init__(self, args, num_tasks, num_layer = 5, emb_dim = 300, gnn_type = 'gin', drop_ratio = 0.5, gamma = 0.4, use_linear_predictor=False):
        ...
        self.teacher = GraphSST2Net(num_tasks, num_layer, emb_dim, gnn_type, drop_ratio, gamma, use_linear_predictor)
    ...
    def forward(self, batched_data):
        ...
        distributional_difference = distributional_difference[:,1].reshape(size,-1)
...
class separator(torch.nn.Module):
    ...
    def eval_forward(self, batched_data, h_node, size=None):
        ...
        h_out = scatter_add(gate, batch, dim=0, dim_size=size)
